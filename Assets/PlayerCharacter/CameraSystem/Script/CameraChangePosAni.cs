...
{
    public abstract class CameraChangePosAni : MonoBehaviour
    {
        #region Inspector
        ...
        #region Event
        /// <summary>
        /// 카메라 위치변경이 시작되는 시점에 호출됩니다.
        /// </summary>
        protected abstract void OnChangePosStart();
        /// <summary>
        /// 카메라 위치변경 업데이트시에 호출됩니다.
        /// </summary>
        /// <param name="normalizedTime">0.0f ~ 1.0f 까지의 normalize된 애니메이션 타임</param>
        /// <returns>이번 프레임의 카메라 줌 사이즈</returns>
        protected abstract Vector3 OnChangePosUpdate(float normalizedTime, Vector3 _startPos, Vector3 _targetPos);
        /// <summary>
        /// 카메라 위치변경이 완료되는 시점에 호출됩니다.
        /// </summary>
        protected abstract void OnChangePosEnd();
        #endregion
        #region Function
        //Public Virtual
        /// <summary>
        ...
        public void ChangePosStart(Vector3 _startPos, Vector3 _targetPos)
        {
            startPos = _startPos;
        ...
        public Vector3 ChangePosUpdate(float normalizedTime)
        {
            return OnChangePosUpdate(normalizedTime, startPos, targetPos);
        }
        /// <summary>
        /// 위치변경을 끝냅니다.
        /// </summary>
        public void ChangePosEnd()
        {
            OnChangePosEnd();
        }
        #endregion
